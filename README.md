...
**Don't have Claude Code set up yet?** This pipeline also works directly on [claude.ai](https://claude.ai) — grab the single-upload `mvp-os.zip` from [mvp-os-skills](https://github.com/peter-tnc-453/mvp-os-skills), or see `docs/USING-ON-CLAUDE-WEB.md` for the full walkthrough.
